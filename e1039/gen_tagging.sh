...
IGUN=2
ZVERTEX=520.00
INPUT_PATH="/seaquest/users/dwong/ntuple_big/"
OUT_FILE="electron_520_20eve.root"
OUT_PATH="/seaquest/users/dwong/ntuple_big/"
PILEUP_FILE="/pnfs/e1039/persistent/users/apun/bkg_study/e1039pythiaGen_26Oct21/10_bkge1039_pythia_wshielding_100M.root"
VERBOSITY=0

# The root command with variables
root -b -q "RecoE1039Sim.C($NEVENTS, $ISIM, $IGUN, $ZVERTEX, true, true, false, '', '', '$OUT_FILE', '$OUT_PATH', '$PILEUP_FILE', $VERBOSITY)"

# Call your Python script with the NTUPLE_PATH variable
NTUPLE_PATH="$OUT_PATH$OUT_FILE"
python /path/to/edit.py "$NTUPLE_PATH"
